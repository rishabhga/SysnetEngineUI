const RemoteSession = (function () {
    ...
    function clearSessionState() {
        ...
        function handlePollingResponse(data) {
            const imageData = data.image || data.Image || data.ImageBase64 || data.imageBase64;
            const frameW = data.width || data.Width || 0;
            const frameH = data.height || data.Height || 0;
        ...
        function handleMouseMove(e) {
            ...
            const nw = remoteWidth || img.naturalWidth;
            const nh = remoteHeight || img.naturalHeight;
            if (!nw || !nh) return;
